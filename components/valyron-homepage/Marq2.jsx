...
function Marq2() {
  const marquess = ['Software Development', 'Web Solutions', 'UI/UX Design', 'Digital Innovation']; // Software-related services
  const AllMarquess = Array(6).fill(marquess).flat();
  const contact = ['Transform Your Business', 'Build With Us', 'Innovate Today']; // Call-to-action phrases
